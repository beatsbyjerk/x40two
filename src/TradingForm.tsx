...
interface TradingCardProps {
  ...
  handleTradeSubmit: (wallets: Wallet[], isBuy: boolean, dex: string, buyAmount?: string, sellAmount?: string) => void;
  isLoading: boolean;
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full px-2 py-2 bg-app-primary border border-app-primary-40 rounded-lg
