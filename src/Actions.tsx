      ...
      <div className="max-w-4xl mx-auto space-y-8 relative z-10">
              ...
              <div className="bg-app-primary-60-alpha p-4 rounded-lg border border-app-primary-40 relative overflow-hidden">
                ...
                <div className="relative">
                  <input
                    ...
                    min="0.001"
                    step="0.001"
                    className="w-full px-2 py-2 bg-app-secondary border border-app-primary-40 rounded-lg
        ...
        <div className="space-y-4">          
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 relative z-10">
              ...
              >
                <div className="p-3 bg-gradient-to-br from-app-primary-20 to-app-primary-05 rounded-lg">
                  <svg viewBox="0 0 24 24" width="20" height="20" className="filter drop-shadow-[0_0_6px_var(--color-primary)]">
                    <text x="12" y="16" textAnchor="middle" fill="var(--color-primary)" fontSize="12" fontFamily="monospace" fontWeight="bold">$</text>
                  </svg>
                </div>
                <span className="text-xs font-mono tracking-wider text-app-secondary uppercase">x40TWO</span>
              </button>
          </div>
